...
urlpatterns = [
    ...
    url(r'^unread_count/$', UnreadNotificationCount.as_view(), name='live_unread_notification_count'),
    url(r'^all_count/$', AllNotificationCount.as_view(), name='live_all_notification_count'),
    url(r'^unread_list/$', UnreadNotificationsList.as_view({'get': 'list'}), name='live_unread_notification_list'),
]
